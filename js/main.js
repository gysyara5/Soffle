...
document.addEventListener("DOMContentLoaded", () => {
  ...
  if (window.innerWidth > 1024) {
    ...
    let titles = document.querySelectorAll(".uniqueness__scroll-item-upper");
    ...
    let scrollbarWidth = window.innerWidth / (container.scrollWidth / window.innerWidth);
      ...
      scrollTrigger: {
        ...
        onUpdate: self => {
          ...
          gsap.to(scrollbarThumb, {
            x: progress * (window.innerWidth - scrollbarWidth),
            ease: "none"
          });
          ...
          slides.forEach((slide, index) => {
            ...
            let distance = Math.abs(slideCenter - center);
        ...
        onEnter: () => gsap.to(scrollbar, {
          opacity: 1,
          duration: 0.3,
          pointerEvents: "auto"
        }),
        onLeave: () => gsap.to(scrollbar, {
          opacity: 0,
          duration: 0.3,
          pointerEvents: "none"
        }),
        onEnterBack: () => gsap.to(scrollbar, {
          opacity: 1,
          duration: 0.3,
          pointerEvents: "auto"
        }),
        onLeaveBack: () => gsap.to(scrollbar, {
          opacity: 0,
          duration: 0.3,
          pointerEvents: "none"
        })
